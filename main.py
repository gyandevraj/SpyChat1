from Existing_Spy import Spy_Name, Spy_Code_Name, Spy_Age #importing spy details.


print "Hello!!! \nWelcome To SpyChat."

#Asking to user (either user is new or not.)
...
if Existing_Spy == "N".lower() or Existing_Spy == "n".upper() :
    ...
    print "You Are Online."
            ...
            if len(Spy_Name)>3:
                ...
                Spy_Salutation = raw_input("What should we call you (Mr. or Ms.)? ") #Asking for salutation
                        ...
                        if 50>Spy_Age>18:
                            ...
                            if Spy_Country == "INDIA".lower() or Spy_Country == "INDIA".upper() or \
                                ...
                                Spy_Decision = raw_input("Are You Sure To Be A Spy?"\
                                                         "(yes , no or may be)?")
                                if Spy_Decision == "yes":
                                    print "Congrats You Are In. " #welcoming to the spy group
